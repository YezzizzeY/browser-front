        ...
        <div class="mysearch-table">
          ...
          >
            <el-table-column
              ...
              label="块高"
              align="center"
              :class-name="'table-link'"
              :show-overflow-tooltip="true"
            >
              <template slot-scope="scope">
                <span
                  @click="linkPage('blockDetail','blockHash',scope.row.blockHash)"
            ...
            >
              <template slot-scope="scope">
                <span
                  @click="linkPage('transaction','blockHeight',scope.row.number)"
                >{{scope.row.txn}}</span>
              </template>
            </el-table-column>
            <el-table-column
